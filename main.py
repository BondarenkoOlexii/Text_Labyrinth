...
optimal_path = [[1, 1], [2, 1], [2, 2], [2, 3], [1, 3], [1, 4], [1, 5], [2, 5],[3, 5],[4, 5],[5, 5],[6, 5],[7, 5],[7, 6],[7, 7],[7, 8],
                [8, 8],[9, 8],[10, 8],[11, 8],[12, 8],[13, 8],[14, 8], [14, 9],[14, 10],[13, 10],[12, 10],[12, 11],[12, 12],[12, 13],
...
while game_on:
    clear_console()
    maze_view = Show_Moza(Labyrinth, player)
